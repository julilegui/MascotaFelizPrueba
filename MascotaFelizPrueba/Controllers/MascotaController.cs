...
namespace MascotaFelizPrueba.Controllers
{
    public class MascotaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Color,Especie,Raza")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Color,Especie,Raza")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
