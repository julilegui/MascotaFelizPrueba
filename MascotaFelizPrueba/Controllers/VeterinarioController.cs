...
namespace MascotaFelizPrueba.Controllers
{
    public class VeterinarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TarjetaProfesional,Id,Identificacion,Nombres,Apellidos,Direccion,Telefono")] Veterinario veterinario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TarjetaProfesional,Id,Identificacion,Nombres,Apellidos,Direccion,Telefono")] Veterinario veterinario)
        {
